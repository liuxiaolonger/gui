...
class FileMenuDialog(QDialog):
    def __init__(self, parent=None):
        ...
        xiangxBtn = QtWidgets.QToolButton()
...
class HomeMenuDialog(QDialog):
    def __init__(self, parent=None):
        QDialog.__init__(self, parent=parent)
        self.setWindowFlags(QtCore.Qt.Popup)
        self.setWindowTitle('FileMenu')
        dingBtn = QtWidgets.QToolButton()
        ...
        deWlab_map.setPixmap(
            QtGui.QPixmap('D:/python2.7/Lib/site-packages/PySide/examples/demos/qtdemo/images/paste.png'))
        copylab = QtGui.QLabel(u'复制')

        pastelab_map = QtGui.QLabel()
        pastelab_map.setPixmap(
            QtGui.QPixmap('D:/python2.7/Lib/site-packages/PySide/examples/demos/qtdemo/images/paste.png'))
        ...
        paixBtn.setAutoRaise(True)
        layout_Vcop = QtWidgets.QVBoxLayout()
        layout_Vcop.addWidget(deWlab_map)
        layout_Vcop.addWidget(copylab)
        layout_Vyul = QtWidgets.QVBoxLayout()
...
class ViewMenuDialog(QDialog):
    def __init__(self, parent=None):
        ...
        yinc_Btn = QtWidgets.QToolButton()
...
class DirBrowser(QTreeWidget):
    def __init__(self, parent=None):
        ...
        for d in self.getDrives():
            item = QTreeWidgetItem(self.root, [d])
            item.path = d
            ...
            for f in files:
                ...
                if os.path.isdir(path):
                    ...
                    if flag & 2 != 0:
                        ...
                        newItem = QtWidgets.QTreeWidgetItem(item, [f])
                        newItem.setIcon(0, Iconitem)
                        newItem.path = path
                        QtWidgets.QTreeWidgetItem(newItem, '')


###############################################右边连接左边列表文件夹的树状列表的Class##################################

class FileBrowers(QDialog):
    def __init__(self, parent=None):
        QDialog.__init__(self, parent=parent)
        ...
        self.tableWidget = QtWidgets.QTabWidget()
        self.tableWidget.setMaximumHeight(100)
        self.tab_file = QtWidgets.QWidget()
        self.list_file = QtWidgets.QListWidget(self.tab_file)
        self.list_file.setGeometry(QtCore.QRect(-1, -1, 800, 100))
        self.list_file.setIconSize(QtCore.QSize(10, 20))
        self.l_button = QtWidgets.QPushButton()
        self.l_button.setIcon(
            QtGui.QIcon('D:/python2.7/Lib/site-packages/PySide/examples/demos/qtdemo/images/open.png'))
        self.l_layout = QtWidgets.QHBoxLayout(self.list_file)
        ...
        self.Hspacer = QtWidgets.QSpacerItem(228, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.button_left = QtWidgets.QToolButton()
        self.button_left.setIcon(
            QtGui.QIcon("D:/python2.7/Lib/site-packages/PySide/examples/demos/qtdemo/images/back.png"))
        self.button_left.setAutoRaise(True)
        self.button_left.clicked.connect(self.__backSignal)

        self.button_right = QtWidgets.QToolButton()
        self.button_right.setIcon(
            QtGui.QIcon("D:/python2.7/Lib/site-packages/PySide/examples/demos/qtdemo/images/move.png"))
        self.button_right.setAutoRaise(True)
        self.button_right.clicked.connect(self.__goSignal)

        self.button_return = QtWidgets.QToolButton()
        self.button_return.setIcon(
            QtGui.QIcon("D:/python2.7/Lib/site-packages/PySide/examples/demos/qtdemo/images/hou.png"))
        ...
        self.refresh_Btn.setIcon(
            QtGui.QIcon("D:/python2.7/Lib/site-packages/PySide/examples/demos/qtdemo/images/refresh.png"))
        ...
        self.searchEdite = QtWidgets.QLineEdit()

        self.searchEdite.textChanged.connect(self.__searchSignal)

        self.gride_layout = QtWidgets.QHBoxLayout()
        self.grideH_layout = QtWidgets.QHBoxLayout()
        ...
        self.spliter_layout = QtWidgets.QSplitter()
        ...
        self.Vsplit_lay = QtWidgets.QSplitter()
        ...
        self.muity_layout = QtWidgets.QVBoxLayout()
        ...
        if len(self.Path) <= 1:
            ...
            for f in files:
                if os.path.isfile(self.Path[len(self.Path) - 1]) == False:
                    ...
                    texts = [f, '', '']
                    Item = QtWidgets.QTreeWidgetItem(self.treeWidget, texts)
